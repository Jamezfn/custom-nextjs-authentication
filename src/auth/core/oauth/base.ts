...
// const CODE_VERIFIER_COOKIE_KEY = "oAuthCoderVerifier";
...
export class OAuthClient<T> {
    ...
    constructor({ provider, clientId, clientSecret, scopes, urls, userInfo }: Prop<T>) {
    ...
    private async fetchToken(code: string, /* codeVerifier: string */) {
        return fetch(this.urls.token, { method: 'POST',
            headers: {
